...
const quickTags = ["إبل", "أغنام", "أبقار", "أعلاف", "مزارع"];
        ...
        <div className="max-w-2xl mr-0 ml-auto md:mr-auto md:ml-0">
          <motion.div
            ...
            <p className="text-lg text-white/85 mb-8 leading-relaxed max-w-xl">
              منصة <strong className="text-accent">الصفاة</strong> تجمع بائعي ومشتري المواشي والأعلاف
              والخدمات الزراعية في مكان واحد آمن وسريع وموثوق
            </p>
