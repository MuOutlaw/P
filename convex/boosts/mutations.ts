...
// Activate a boost directly (used after successful payment, or for free/test boosts)
...
// Expire old boosts and un-feature listings whose boosts have all expired
export const expireOldBoosts = mutation({
  args: {},
  handler: async (ctx) => {
