...
export const list = query({
  ...
  handler: async (ctx, args) => {
    ...
    if (args.sortBy === "price_asc") filtered.sort((a, b) => a.price - b.price);
    if (args.sortBy === "price_desc") filtered.sort((a, b) => b.price - a.price);
...
export const incrementViews = query({
  args: { id: v.id("listings") },
  handler: async (ctx, args) => {
    // Views increment is done client-side via mutation; this just returns current
